...
public static class GuiHelper
{
    ...
    private static readonly RasterizerState _rasterState = new() {ScissorTestEnable = true};
    private static bool _beginCalled;
    private static readonly Stack<(Rectangle, bool)> _scissorStack = new();
    ...
    public static Vector2 Mouse =>
        Vector2.Transform(InputHelper.NewMouse.Position.ToVector2(), Matrix.Invert(UIMatrix));
    ...
    public static Vector2 FontScale => new(_finalScale);
    ...
    public static void PushScissor(RectangleF r)
    {
        ...
        var wasBeginCalled = _beginCalled;
        if (wasBeginCalled) End();
