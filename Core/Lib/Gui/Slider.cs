...
public class Slider : Component
{
    ...
    public override void UpdateInput(GameTime gameTime)
    {
        ...
        {
            _isPressed = true;
            var percent = (GuiHelper.Mouse.X - Left) / (Width - _thickness);
    ...
    public override void Draw(GameTime gameTime)
    {
        ...
        GuiHelper.SpriteBatch.FillRectangle(
            new RectangleF(Left + (Width - _thickness) * percent, Top, _thickness, Height), c);
        GuiHelper.SpriteBatch.FillRectangle(
            new RectangleF(Left + (Width - _thickness) * percent - _handleThickness / 2, Top + Height * 0.4f,
                _thickness + _handleThickness, 2), c);
        GuiHelper.SpriteBatch.FillRectangle(
            new RectangleF(Left + (Width - _thickness) * percent - _handleThickness / 2, Top + Height * 0.6f,
                _thickness + _handleThickness, 2), c);
