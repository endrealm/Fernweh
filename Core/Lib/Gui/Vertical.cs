...
public class Vertical : Component, IParent
{
    ...
    public override void UpdateSetup(GameTime gameTime)
    {
        ...
        if (_offsetYTween.B != ClampOffsetY(_offsetYTween.B)) SetOffset(_offsetYTween, ClampOffsetY(_offsetYTween.B));
    ...
    public override void UpdateInput(GameTime gameTime)
    {
        ...
        if (Clip.Contains(GuiHelper.Mouse) && Track.MouseCondition.Scrolled())
            SetOffset(_offsetYTween,
                ClampOffsetY(_offsetYTween.B + Math.Sign(MouseCondition.ScrollDelta) * ScrollIncrement));
