...
public class AttackAction : IBattleAction
{
    ...
    {
        context.QueueAction(new LogTextAction("battle.action.attack",
            new TextReplacement("name", Participant.DisplayName), new TextReplacement("target", _target.DisplayName)));
