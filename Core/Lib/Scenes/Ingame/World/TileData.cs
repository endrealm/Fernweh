...
public class TileData
{
    ...
    public TileData(string name, string[] frames,
        OpenDirection openDirections = OpenDirection.Up | OpenDirection.Down | OpenDirection.Left | OpenDirection.Right)
    {
        this.name = name;
        framePaths = frames;
    ...
    {
        return contentRegistry.pngs
            [framePaths[0]]; // return first frame for now, im not sure how ill implement anims yet. but itll probably be calculated in here based from some time parameter
    }
