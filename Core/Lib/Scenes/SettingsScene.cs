...
public class SettingsScene : Scene
{
    ...
    public SettingsScene(ILocalizationManager rootLocalizationManager, IFontManager fontManager, Scene previousScene) :
    ...
    {
        Vertical.Push();
        if (Button.Put("Back").Clicked) SceneManager.LoadScene(_previousScene);
        MenuPanel.Push();
        Label.Put("Music Volume: " + (int) (GameSettings.Instance.Music * 100) + "%").PrefWidth =
            context.Camera.BoundingRectangle.Width / 2;
        Slider.Put(ref GameSettings.Instance.Music, 0, 1);
        Label.Put("SFX Volume: " + (int) (GameSettings.Instance.Sfx * 100) + "%").PrefWidth =
            context.Camera.BoundingRectangle.Width / 2;
        ...
        Label.Put("Typing Speed: " + GameSettings.Instance.TypingSpeed).PrefWidth =
            context.Camera.BoundingRectangle.Width / 2;
